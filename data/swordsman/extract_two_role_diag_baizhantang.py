...
if __name__ == "__main__":
    ...
    diags = json.load(open("myownswordsman_diags.json", encoding='utf-8'))
    ...
    os.makedirs("diags_two_role_baizhantang/configs", exist_ok=True)
    json.dump(role_pinyin, open("diags_two_role_baizhantang/configs/role_list.json", 'w', encoding='utf-8'), ensure_ascii=False, indent=4)
    ...
    for role2 in role_pinyin:
        ...
        if len(new_diags) < 20:
            ...
            continue
        output_dir = f'diags_two_role_baizhantang/{role1_pinyin}_{role2_pinyin}'
    ...
    json.dump(role_pair_id, open("diags_two_role_baizhantang/configs/role_pair_id.json", 'w', encoding='utf-8'), ensure_ascii=False, indent=4)
    for role2 in role_pinyin: 
        role2_pinyin = role_pinyin[role2]
        input_dir = f'diags_two_role_baizhantang/{role1_pinyin}_{role2_pinyin}'
