...
## my own swordsman
####################################################################
OUTPUT_PATH="output/swordsman_baizhantang/finetune_qar"
...
DATA_ROOT="data/swordsman/diags_two_role_baizhantang_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/swordsman/diags_two_role_baizhantang_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
