...
## my own swordsman
####################################################################
OUTPUT_PATH="output/swordsman_lvxiucai/finetune_qar"
...
DATA_ROOT="data/swordsman/diags_two_role_lvxiucai_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/swordsman/diags_two_role_lvxiucai_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
