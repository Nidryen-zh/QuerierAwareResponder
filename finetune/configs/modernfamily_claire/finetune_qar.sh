...
####################################################################
OUTPUT_PATH="output/modernfamily_claire/finetune_qar"
...
DATA_ROOT="data/modernfamily/diags_two_role_claire_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/modernfamily/diags_two_role_claire_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
