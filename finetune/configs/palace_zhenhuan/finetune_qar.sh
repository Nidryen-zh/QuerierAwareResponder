...
####################################################################
OUTPUT_PATH="output/palace_zhenhuan/finetune_qar"
...
DATA_ROOT="data/palace/diags_two_role_zhenhuan_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/palace/diags_two_role_zhenhuan_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
