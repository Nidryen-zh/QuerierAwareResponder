####################################################################
## friends role decomposition 
####################################################################
OUTPUT_PATH="output/friends_rachel/finetune_qar"
...
DATA_ROOT="data/friends/diags_two_role_rachel_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/friends/diags_two_role_rachel_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
