####################################################################
## wechat role decomposition 
####################################################################
OUTPUT_PATH="output/wechat/finetune_qar"
...
DATA_ROOT="data/wechat/diags_two_role_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/wechat/diags_two_role_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
