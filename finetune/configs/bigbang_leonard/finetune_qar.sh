####################################################################
## bigbang role decomposition   
####################################################################
OUTPUT_PATH="output/bigbang_leonard/finetune_qar"
...
DATA_ROOT="data/bigbang/diags_two_role_leonard_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/bigbang/diags_two_role_leonard_clustered/*"
