...
####################################################################
OUTPUT_PATH="output/bigbang_sheldon/finetune_qar"
...
DATA_ROOT="data/bigbang/diags_two_role_sheldon_clustered"
DATA_EVAL=()
DATA=()
ROOT="data/bigbang/diags_two_role_sheldon_clustered/*"
for dir in $ROOT
do
  if test -d $dir
  then
